...
.w3-sidebar{
  ...
  <a href="#" class="w3-bar-item w3-button">Edit Menu</a>
  <a id="active" class="w3-bar-item w3-button">View Orders</a>
	...
	<tr>
        ...
        <?php
        	foreach ($data["orders"] as $orders) {
        		...
        		echo "<td>$orders->foodName</td>";
        		echo "<td>$orders->orderTime</td>";
        		echo "<tr>";
        	}
