	...
	<div id="header">
		...
		<nav>
			...
			Home</a> 
  			...
  			<a style="color: red" href="/SysDevProject/cart">
		...
		Cart</a> 
            ...
            <br><form method="post">
                <center>Sign in to your account</center><br><br>
                    ...
                    <br><a style="color: red" href="/SysDevProject/Login/reset">Forgot password?</a><br>
  					<input type="password" id="Password" name="Password" value=""align="right" placeholder="Enter Your Password.."><br><br>
  					<button type="submit" name="login" class="btn btn-primary">Sign in</button>
  					<br><p>New Client?		<a style="color: red" href="/SysDevProject/Login/create">Create Account</a></p>
                </form>
